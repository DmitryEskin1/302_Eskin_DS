...
namespace Eskin\Tests;

use PHPUnit\Framework\TestCase;
use Eskin\Task062\EconomyRoom;
use Eskin\Task06_2\StandardRoom;
use Eskin\Task06_2\SuiteRoom;
use Eskin\Task06_2\InternetDecorator;
use Eskin\Task06_2\BreakfastDecorator;
use Eskin\Task06_2\FoodDeliveryDecorator;
use Eskin\Task06_2\SofaDecorator;
